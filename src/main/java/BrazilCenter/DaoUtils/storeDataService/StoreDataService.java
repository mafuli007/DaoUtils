	...
	public static String storeData(FileObj task, String storePath) {
		...
		if (infolist.length == 6) {
			...
			if (stationId != null && deviceId != null && dataId != null && dataDate != null) {
				storePath = storePath + File.separator + stationId + File.separator + deviceId + File.separator + dataId
						+ File.separator + dataDate;
			} else {
			...
			// if the infolist < 6, the file's name is illegal.
			return null;
		}
	}
}
